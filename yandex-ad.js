(function () {
    ...
    setTimeout(function() {
        ...
        // Проверяем, не был ли скрипт уже запущен
        ...
        // Инициализируем массив колбэков
        window.yaContextCb = window.yaContextCb || [];
        console.log('WIX-AD-LOADER: Массив yaContextCb готов.');

        // Добавляем функцию рендера в массив
        ...
        // Загружаем основной скрипт Яндекса, если его еще нет
